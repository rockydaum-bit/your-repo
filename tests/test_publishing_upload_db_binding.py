...
def test_upload_binds_youtube_id_and_logs_event(tmp_path, monkeypatch):
    ...
    save_json(meta_path, {"video_id": "v1", "title": "T", "description": "D", "tags": [], "privacy_status": "private"})
    ...
    # stub cfg
    cfg = SimpleNamespace(engine_root=root, youtube=SimpleNamespace(client_secrets_path="s", token_path="t"), enable_auto_promote=False)
